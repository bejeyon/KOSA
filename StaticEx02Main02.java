...
class StaticEx02Main02 extends StaticEx02 {

	void mStatic02() {	// error: mStatic02() in StaticEx02Main02 cannot override mStatic02() in StaticEx02. static 메소드는 override 불가능
		vI01++;
		vI02++;
	}
